...
export class AddInvestmentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.recentInvestments.push({category: "Chit", date: '15-05-24', amount:6000, note:'Chit Investment'});
    this.recentInvestments.push({category: "Gold", date: '15-05-24', amount:5000, note:'Gold bees'});
